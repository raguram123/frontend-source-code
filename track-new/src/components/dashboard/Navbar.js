...
function Navbar() {
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-warning p-3 bg-light">
            <Link className="navbar-brand" to="#">TrackZee</Link>
            ...
            <div className={show ? "collapse navbar-collapse show" : "collapse navbar-collapse"} id="navbarNavAltMarkup">
                <div className="navbar-nav">
                    ...
                    <Link className="nav-item nav-link" to="/portal/book">Products</Link>
                   <Link className="nav-item nav-link" to="/portal/dashboard">HomePage</Link> 
